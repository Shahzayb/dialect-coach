...
NO_NOTE = "No articulation note for this pair yet — the substitution itself is still what to drill."
...
_CONSONANTS: tuple[Phoneme, ...] = (
    ...
    _p(
        ...
        _c(
            "s",
            "The word becomes another word: think lands as sink, mouth as mouse. The "
        ...
        _c(
            "t",
            "Thin becomes tin, three becomes tree. The sentence still parses, so nobody "
        ...
        _c(
            "f",
            "Three becomes free and thirst becomes first. It is also heard as a speech "
    ...
    _p(
        ...
        _c(
            "d",
            "They becomes day, though becomes dough. These are the highest-frequency "
        ...
        _c(
            "z",
            "Breathe lands as breeze, lathe as laze — the tongue pulls back behind the "
        ...
        _c(
            "v",
            "That becomes vat, clothe becomes clove. Rarer than the /d/ swap, but it "
    ...
    _p(
        ...
        _c(
            "w",
            "Vest and west, vine and wine are different words, and both are common "
        ...
        _c(
            "b",
            "Curve becomes curb, vote becomes boat. The lips meeting is the entire "
        ...
        _c(
            "f",
            "Losing the voicing turns leave into leaf and prove into proof, usually at "
    ...
    _p(
        ...
        _c(
            "v",
            "West lands as vest. The fix is at the lips: /w/ rounds them, /v/ needs the "
    ...
    _p(
        ...
        _c(
            "f",
            "The lips stop meeting: pine becomes fine, copy becomes coffee.",
            ("pine", "fine"),
            ("pan", "fan"),
            ("copy", "coffee"),
            ("leap", "leaf"),
        ...
        _c(
            "b",
            "Voicing it turns cap into cab and rope into robe.",
            ("pat", "bat"),
            ("pin", "bin"),
            ("cap", "cab"),
            ("rope", "robe"),
    ...
    _p(
        ...
        _c(
            "p",
            "Losing the voice turns cab into cap and robe into rope.",
            ("bat", "pat"),
            ("bin", "pin"),
            ("cab", "cap"),
            ("robe", "rope"),
        ...
        _c(
            "v",
            "The lips open into a gap instead of meeting: boat becomes vote, curb becomes curve.",
            ("boat", "vote"),
            ("ban", "van"),
            ("curb", "curve"),
            ("marble", "marvel"),
    ...
    _p(
        ...
        _c(
            "d",
            "Voicing it turns write into ride and bet into bed.",
            ("write", "ride"),
            ("bet", "bed"),
            ("latter", "ladder"),
            ("town", "down"),
        ...
        _c(
            "tʃ",
            "The release drags backward into a /ʃ/, so tip lands as chip and tin as chin.",
            ("tip", "chip"),
            ("tin", "chin"),
            ("taste", "chased"),
        ),
    ...
    _p(
        ...
        _c(
            "t",
            "Dropping the voicing turns ride into write and bed into bet — most often at "
        ...
        _c(
            "ð",
            "The tongue slips forward onto the teeth: den becomes then, day becomes they.",
            ("den", "then"),
            ("day", "they"),
            ("dough", "though"),
        ),
    ...
    _p(
        ...
        _c(
            "g",
            "Voicing turns coat into goat and back into bag.",
            ("coat", "goat"),
            ("back", "bag"),
            ("cap", "gap"),
            ("ankle", "angle"),
    ...
    _p(
        ...
        _c(
            "k",
            "Losing the voice turns goat into coat and bag into back.",
            ("goat", "coat"),
            ("bag", "back"),
            ("gap", "cap"),
        ),
    ...
    _p(
        ...
        _c(
            "ʃ",
            "Dropping the stop at the front turns chip into ship and chair into share.",
            ("chip", "ship"),
            ("chair", "share"),
            ("cheap", "sheep"),
            ("watch", "wash"),
        ...
        _c(
            "dʒ",
            "Adding voice turns batch into badge and cheap into jeep.",
            ("batch", "badge"),
            ("cheap", "jeep"),
            ("rich", "ridge"),
        ),
    ...
    _p(
        ...
        _c(
            "z",
            "The stop at the front goes missing, so rage lands as raze and budge as buzz.",
            ("rage", "raze"),
            ("budge", "buzz"),
            ("jest", "zest"),
        ),
        _c(
            "tʃ",
            "Losing the voicing turns badge into batch and jeep into cheap.",
            ("badge", "batch"),
            ("jeep", "cheap"),
            ("ridge", "rich"),
        ),
    ...
    _p(
        ...
        _c(
            "p",
            "The lips close and fine becomes pine, coffee becomes copy.",
            ("fine", "pine"),
            ("fan", "pan"),
            ("coffee", "copy"),
            ("leaf", "leap"),
        ...
        _c(
            "v",
            "Adding voice turns leaf into leave and safe into save.",
            ("leaf", "leave"),
            ("safe", "save"),
            ("proof", "prove"),
            ("fan", "van"),
    ...
    _p(
        ...
        _c(
            "ʃ",
            "Sip becomes ship, sell becomes shell — the tongue slides back and the lips round.",
            ("sip", "ship"),
            ("sell", "shell"),
            ("mass", "mash"),
            ("seat", "sheet"),
        ...
        _c(
            "z",
            "Voicing it turns bus into buzz and price into prize.",
            ("bus", "buzz"),
            ("price", "prize"),
            ("ice", "eyes"),
        ),
        _c(
            "θ",
            "The tongue tip comes forward past the teeth and sink lands as think.",
            ("sink", "think"),
            ("sing", "thing"),
            ("pass", "path"),
            ("mouse", "mouth"),
    ...
    _p(
        ...
        _c(
            "s",
            "Losing the voicing turns prize into price and eyes into ice, and it takes "
        ...
        _c(
            "dʒ",
            "Stopping the air before releasing it turns raze into rage and buzz into budge.",
            ("raze", "rage"),
            ("buzz", "budge"),
            ("zest", "jest"),
        ),
    ...
    _p(
        ...
        _c(
            "s",
            "Ship becomes sip, mash becomes mass: the tongue is too far forward and the "
        ...
        _c(
            "tʃ",
            "A stop appears at the front and ship lands as chip, share as chair.",
            ("ship", "chip"),
            ("share", "chair"),
            ("sheep", "cheap"),
            ("wash", "watch"),
    ...
    _p(
        ...
        _c(
            "ʃ",
            "Losing the voice makes confusion sound like Confucian.",
            ("confusion", "Confucian"),
        ),
        _c(
            "dʒ",
            "It gains a stop at the front, so a sound English keeps smooth inside a "
            "word lands as the j of judge.",
        ),
        _c("z", "The tongue moves forward and beige lands as bays.", ("beige", "bays")),
    ),
    _p(
        "h",
        "h",
    ...
    _p(
        ...
        _c(
            "ŋ",
            "The closure moves to the back of the mouth: thin becomes thing, sin becomes sing.",
            ("thin", "thing"),
            ("sin", "sing"),
            ("ban", "bang"),
            ("ran", "rang"),
        ...
        _c(
            "l",
            "The air stops going through the nose: night becomes light, no becomes low.",
            ("night", "light"),
            ("not", "lot"),
            ("no", "low"),
        ),
    ...
    _p(
        ...
        _c(
            "n",
            "The closure moves forward to the ridge and sing lands as sin.",
            ("sing", "sin"),
            ("thing", "thin"),
            ("rang", "ran"),
        ),
    ...
    _p(
        ...
        _c(
            "w",
            "A dark /l/ collapsing into a /w/ makes light sound like white and feel like few.",
            ("light", "white"),
            ("led", "wed"),
            ("lake", "wake"),
            ("lie", "why"),
        ...
        _c(
            "ɹ",
            "The tip leaves the ridge and curls back: light becomes right, collect "
            "becomes correct.",
            ("light", "right"),
            ("lock", "rock"),
            ("glass", "grass"),
        ...
        _c(
            "n",
            "The air goes through the nose instead of around the tongue and light lands as night.",
            ("light", "night"),
            ("lot", "not"),
            ("low", "no"),
        ),
    ...
    _p(
        ...
        _c(
            "l",
            "Right becomes light, correct becomes collect.",
            ("right", "light"),
            ("rock", "lock"),
            ("grass", "glass"),
            ("pray", "play"),
        ...
        _c(
            "w",
            "The tongue stays flat and only the lips do the work, so red lands as wed.",
            ("red", "wed"),
            ("right", "white"),
            ("rake", "wake"),
        ),
    ...
    _p(
        ...
        _c(
            "dʒ",
            "The tongue touches the ridge and stops the air, so year lands as jeer.",
            ("year", "jeer"),
            ("yam", "jam"),
            ("yet", "jet"),
        ),
...
_VOWELS: tuple[Phoneme, ...] = (
    ...
    _p(
        ...
        _c(
            "ɛ",
            "Bad and bed, man and men. The vowel is carrying the meaning on its own, and "
        ...
        _c(
            "ʌ",
            "Cat becomes cut and ran becomes run — the tense of the sentence changes "
            "with the vowel.",
            ("cat", "cut"),
            ("bat", "but"),
            ("ran", "run"),
        ...
        _c(
            "ɑ",
            "Cap becomes cop. Both are open vowels; the difference is that /æ/ is "
    ...
    _p(
        ...
        _c(
            "ɪ",
            "Pen and pin, desk and disk. Before /n/ these are already merged for some "
        ...
        _c(
            "eɪ",
            "The vowel stretches into a glide and wet becomes wait, sell becomes sail.",
            ("wet", "wait"),
            ("sell", "sail"),
            ("pen", "pain"),
            ("test", "taste"),
        ...
        _c(
            "æ",
            "Bed lands as bad, men as man — the jaw drops too far.",
            ("bed", "bad"),
            ("men", "man"),
            ("said", "sad"),
            ("bet", "bat"),
    ...
    _p(
        ...
        _c(
            "i",
            "Ship becomes sheep, live becomes leave. English separates these by tongue "
        ...
        _c(
            "ɛ",
            "Bid lands as bed and sit as set: the jaw opens too far.",
            ("bid", "bed"),
            ("sit", "set"),
            ("disk", "desk"),
            ("pin", "pen"),
    ...
    _p(
        ...
        _c(
            "ɪ",
            "Sheep becomes ship — the tongue relaxes and the vowel is cut short.",
            ("sheep", "ship"),
            ("beat", "bit"),
            ("leave", "live"),
            ("feel", "fill"),
    ...
    _p(
        ...
        _c(
            "æ",
            "Cop becomes cap, hot becomes hat: the tongue comes forward and the lips spread.",
            ("cop", "cap"),
            ("sock", "sack"),
            ("hot", "hat"),
            ("odd", "add"),
        ...
        _c(
            "ɔ",
            "Worth knowing before drilling it: most American speakers merge these, so "
    ...
    _p(
        ...
        _c(
            "ɑ",
            "Cut becomes cot — the tongue drops too far back and the throat opens.",
            ("cut", "cot"),
            ("hut", "hot"),
            ("cup", "cop"),
            ("duck", "dock"),
        ...
        _c(
            "ʊ",
            "Luck becomes look and buck becomes book: the lips round when they should stay slack.",
            ("luck", "look"),
            ("buck", "book"),
            ("tuck", "took"),
        ),
    ...
    _p(
        ...
        _c(
            "æ",
            "The r-colour is dropped and the vowel opens out, so hurt lands as hat and "
        ...
        _c(
            "ɔɹ",
            "Bird becomes board, turn becomes torn: the tongue sits too far back and "
            "the lips round.",
            ("bird", "board"),
            ("turn", "torn"),
            ("were", "wore"),
        ...
        _c(
            "ɑɹ",
            "Hurt becomes heart and burn becomes barn — the jaw opens under the r-colour.",
            ("hurt", "heart"),
            ("burn", "barn"),
            ("curb", "carb"),
        ),
    ...
    _p(
        ...
        _c(
            "ʌ",
            "The same tongue position doing a different job: /ʌ/ takes stress and /ə/ "
    ...
    _p(
        ...
        _c(
            "u",
            "Full becomes fool, look becomes Luke — the lips tighten and the vowel is "
            "held too long.",
            ("full", "fool"),
            ("pull", "pool"),
            ("could", "cooed"),
        ...
        _c(
            "ʌ",
            "Look becomes luck: the lips lose their rounding altogether.",
            ("look", "luck"),
            ("book", "buck"),
            ("took", "tuck"),
        ),
    ...
    _p(
        ...
        _c(
            "ʊ",
            "Fool becomes full and pool becomes pull — the vowel is cut short and the "
            "lips slacken.",
            ("fool", "full"),
            ("pool", "pull"),
            ("Luke", "look"),
    ...
    _p(
        ...
        _c(
            "ɑ",
            "Caught becomes cot. Standard for most American speakers — only worth "
    ...
    _p(
        ...
        _c(
            "ə",
            "The r-colour is dropped and the ending goes non-rhotic in an accent that "
            "is rhotic everywhere else, which is why it stands out so sharply.",
        ),
        _c(
            "ɑ",
            "The ending is given a full open vowel, so it takes a beat of its own and "
    ...
    _p(
        ...
        _c(
            "ɛ",
            "The glide is dropped and wait becomes wet, sail becomes sell.",
            ("wait", "wet"),
            ("sail", "sell"),
            ("pain", "pen"),
            ("taste", "test"),
    ...
    _p(
        ...
        _c(
            "ɑ",
            "The glide never happens and light lands as lot.",
            ("light", "lot"),
            ("bite", "bot"),
        ),
    ),
    _p(
        ...
        _c(
            "ɔ",
            "The glide is flattened out and boat becomes bought, low becomes law.",
            ("boat", "bought"),
            ("coat", "caught"),
            ("low", "law"),
        ),
    ...
    _p(
        ...
        _c(
            "oʊ",
            "The opening half is lost, so house lands as hose and loud as load.",
            ("house", "hose"),
            ("loud", "load"),
            ("now", "no"),
        ),
    ...
    _p(
        ...
        "oy (CHOICE)",
        "diphthong",
        "Start with rounded lips at /ɔ/ and glide up and forward to /ɪ/, unrounding as you go.",
        ("boy", "noise", "point", "enjoy"),
        _c(
            "ɔ",
            "The glide is dropped and boil becomes ball, coil becomes call.",
            ("boil", "ball"),
            ("coil", "call"),
        ),
    ),
    ...
    _p(
        ...
        _c(
            "ɑ",
            "The r-colour is dropped and card lands as cod, heart as hot.",
            ("card", "cod"),
            ("heart", "hot"),
            ("park", "pock"),
        ),
        _c(
            "ɝ",
            "The jaw closes too far under the r-colour: barn becomes burn, heart becomes hurt.",
            ("barn", "burn"),
            ("heart", "hurt"),
            ("carb", "curb"),
        ),
    ...
    _p(
        ...
        _c(
            "ɝ",
            "Born becomes burn, torn becomes turn — the lips lose their rounding.",
            ("born", "burn"),
            ("torn", "turn"),
            ("wore", "were"),
        ),
        _c(
            "ɑɹ",
            "The jaw opens too far and born lands as barn, cord as card.",
            ("born", "barn"),
            ("cord", "card"),
            ("port", "part"),
        ),
    ...
    _p(
        ...
        _c(
            "ɪɹ",
            "The jaw closes too far and hair lands as hear, chair as cheer.",
            ("hair", "hear"),
            ("chair", "cheer"),
            ("bear", "beer"),
        ),
        _c("ɝ", "Hair becomes her, care becomes cur.", ("hair", "her"), ("care", "cur")),
    ),
    _p(
        "ɪɹ",
        "ear (NEAR)",
        ...
        _c(
            "ɛɹ",
            "The jaw opens too far and beer lands as bear, cheer as chair.",
            ("beer", "bear"),
            ("hear", "hair"),
            ("cheer", "chair"),
        ),
    ...
    _p(
        ...
        _c(
            "ɔɹ",
            "Tour becomes tore. Standard for a large share of American speakers, so "
